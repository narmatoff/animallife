...
$FORMS['mail_registrated_subject'] = "Регистрация на %domain%";
...
$FORMS['mail_registrated'] = <<<MAIL
	...
	<p>
	Здравствуйте, %kontaktnoe_lico%!<br />
	Спасибо за регистрацию на сайте <a href="http://%domain%">%domain%</a><br />
	После одобрения вашей регистрации администрацией сайта, вы сможете получить доступ в свой личный кабинет, используя введенные при регистрации логин и пароль.<br />
...
Посмотреть его профиль  можно по в администраторской панели
// <div class="notice">
// 			Чтобы активировать Его аккаунт, необходимо перейти по ссылке, либо скопировать ее в адресную строку браузера:<br />
