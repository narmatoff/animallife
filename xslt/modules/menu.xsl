    ...
    <xsl:template match="item" >
        ...
        <xsl:choose>
            <xsl:when test="@link = $uri">
                <td>
                    <a class="active" href="{@link}"><xsl:value-of select="."/></a>
                </td>
            </xsl:when>
            <xsl:when test="@link != $uri">
                <td>
            ...
            <div class="r-col">
                <table>
                    <tr>
                        <xsl:apply-templates select="items/item"/>
                        <td>
                            <a href="{@link}"><xsl:value-of select="item"/></a>
                        </td>
        ...
        <aside class="align-c">
            <div class="ads-brief">
                ...
                <div class="ads-brief-add">
                    <img src="{$template-resources}/images/plus22x22.jpg"
                         alt="добавить объявление"/>
